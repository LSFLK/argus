...
// This model is designed to be reusable across different projects and microservices
type AuditLog struct {
	...
	Metadata JSONBRawMessage `json:"metadata,omitempty"` // Consolidated metadata
