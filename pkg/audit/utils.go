...
// GetGlobalAuditClient returns the global audit client instance.
// This is a convenience function that extracts the client from the global middleware.
func GetGlobalAuditClient() Auditor {
	middleware := GetGlobalAuditMiddleware()
	if middleware == nil {
		return nil
	}
